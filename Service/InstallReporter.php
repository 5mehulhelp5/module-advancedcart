<?php
/**
 * Standalone install + heartbeat reporter for Panth_AdvancedCart.
 *
...
namespace Panth\AdvancedCart\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_AdvancedCart';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-advancedcart';
